...
function setup(){
  ...
  //grid = new GridLayout(mainPanel, 1, 1);
  ...
  // TODO: add list layout and make it the default panel layout
  p0.addItem(new Label('LABEL', 15, 15, 100, 30));
  p0.addItem(new Label('second', 100, 100, 150, 30));
...
function draw(){
  image(mainPanel.render(), 0, 0);
  //image(mainPanel.render(), 0, 0, 100, 100);
}
